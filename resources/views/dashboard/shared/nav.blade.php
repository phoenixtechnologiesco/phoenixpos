      <div class="c-sidebar-brand"><img class="c-sidebar-brand-full" src="/assets/img/phoenixlogo.png" width="80" height="63" alt="Phoenix Logo"><img class="c-sidebar-brand-minimized" src="assets/img/phoenixlogo.png" width="80" height="63" alt="Phoenix Logo"></div>
      {{-- width="118" height="46" --}}

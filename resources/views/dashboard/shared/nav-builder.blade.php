...
?>
        ...
        <div class="c-sidebar-brand">
            <img class="c-sidebar-brand-full" src="{{ url('/assets/img/phoenixlogo.png') }}" width="80" height="63" alt="Phoenix Logo">
            <div class="c-sidebar-brand-full text-right"><strong>Phoenix POS</strong></div>
            <img class="c-sidebar-brand-minimized" src="{{ url('assets/img/phoenixlogo.png') }}" width="80" height="63" alt="Phoenix Logo">
            <div class="c-sidebar-brand-minimized text-right"><strong>Phoenix POS</strong></div>
        </div>

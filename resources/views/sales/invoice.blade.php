...
<html>
  <head>
    ...
    <title>{{__('Phoenix General Store')}}</title>
        ...
        <div id="receipt-data">
            {{-- <div class="centered">
                <div class="row">
                    <div class="form-col-6">
                        <img src="{{asset('assets/img/phoenixlogo.png')}}" height="60" width="84" style="margin:5px 0;filter: brightness(0);">&nbsp;
                    </div>
                </div>
            </div> --}}
            <table >
                <thead>
                    <tr class="custom-td">
                        <td class="custom-td" style="text-align:left"><img src="{{asset('assets/img/phoenixlogo.png')}}" height="60" width="84" style="margin:5px 0;filter: brightness(0);">&nbsp;</td>
                        <td class="custom-td"><strong>{{__('Phoenix General Store')}}</strong></td>
                    </tr>
                </thead>
                <tbody>
                    <tr class="custom-td">
            ...
            <div class="centered" style="margin:0px 0 50px">
                <p class="text-lowercase">
                    ...
                    <br>
                    {{__('To order online visit our website www.phoenixtechnologies.co')}}
                    <br>
                    {{__('For retailers: www.wholesale.pk.')}}
                </p>
                <p>

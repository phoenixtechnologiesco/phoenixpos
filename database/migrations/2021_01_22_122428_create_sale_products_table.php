...
class CreateSaleProductsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('sale_products', function (Blueprint $table) {
            ...
            $table->integer('sale_pieces_total');
            $table->integer('sale_packets_total');
            $table->integer('sale_cartons_total');
            $table->integer('sale_quantity_total');
            ...
            $table->integer('sale_product_sub_total');
